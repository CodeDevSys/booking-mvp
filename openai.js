...
async function parseBookingIntent(message, context = {}) {
  ...
  const system = `You help users book appointments. Business hours: ${process.env.BUSINESS_START || 9}:00–${process.env.BUSINESS_END || 17}:00, Mon–Fri, ${process.env.SLOT_MINUTES || 30}-minute slots.
...
module.exports = { parseBookingIntent, isEnabled: () => !!getClient() };
